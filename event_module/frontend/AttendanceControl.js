...
const AttendanceControl = () => {
    ...
    useEffect(() => {
        if (mode === 'camera') {
            const scanner = new Html5QrcodeScanner("live-reader", { fps: 10, qrbox: { width: 250, height: 250 }, supportedScanTypes: [0] }, false);
